        ...
        <section class="slider">
            <div class="container">
                <div class="flexslider">
                  ...
                  ?>
                        <li>
                            <?php the_post_thumbnail('shop-slider', array('class' => 'img-fluid')) ?>
                            <div class="slider-details-container">
                                ...
                                <div class="slider-description">
                                    ...
                                    <a href="<?php echo $slider_button_text[$j] ?>"
                                        class="link"><?php echo $slider_button_url[$j]; ?></a>
                                </div>
                            </div>
                    ...
                    <a href="<?php the_permalink(); ?>">
                        <?php 
                           if(has_post_thumbnail()):
                            the_post_thumbnail('shop-blog', array('class' => 'img-fluid'));
                           endif;
                        ?>
                    </a>
                        <h3>
